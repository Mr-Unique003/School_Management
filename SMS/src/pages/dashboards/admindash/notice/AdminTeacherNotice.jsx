...
import "./AdminStudentNotice.css"; // Assuming the same styles apply

const AdminTeacherNotice = () => {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            setError(err.message || "Error deleting notice.");
        }
    };
...
export default AdminTeacherNotice;
